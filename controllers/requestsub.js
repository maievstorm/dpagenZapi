...
async function createRequestsub(body) {
    return db.tx(async t => {
        ...
        "VALUES($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id", [body.user_account_id,body.user_name,body.fullname,body.email,body.offer_id,body.plan_id,body.request_date,body.request_status]);
        return {
            prod
        }
    });
